document.addEventListener("DOMContentLoaded", () => {
  ...
  // highlighting the winning 4 cells
  let winningCells = [];
  ...
  // prevents clicks during the turns
  ...
  /** disable board clicks (during animation / AI turn) **/
  function disableBoard() {
    boardEnabled = false;
    gameDiv.classList.add("disabled");
  }

  /** enable board clicks only if allowed **/
  ...
  function minimax(board, depth, alpha, beta, maximizing) {
    ...
    const savedWinningCells = [...winningCells];
    ...
    // restore UI highlight state
    winningCells = savedWinningCells;
